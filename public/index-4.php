...
<html lang="zxx">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-xl-7">
                            ...
                            <div class="hero-content">
                                <span class="sub-title wow fadeInUp" data-wow-delay=".3s">Welcome to GoWilds</span>
                                <h1 class="wow fadeInDown" data-wow-delay=".5s">Explore Dream
                                    Tour & Travels</h1>
                                <p class="wow fadeInUp" data-wow-delay=".6s">Sit amet consectetur integer tincidunt sceleries nolesry volutpat fermentum
                                    malesuada scelequecy leocras odio blandit rhoncus eues feugiat</p>
                                <!--=== Hero Search ===-->
                                <div class="hero-search-form mb-40 wow fadeInDown" data-wow-delay=".7s">
                                ...
                                <div class="avatar-box wow fadeInUp" data-wow-delay=".75s">
                        ...
                        <div class="col-xl-5 d-xl-block d-none">
                            <div class="hero-image wow fadeInRight" data-wow-delay=".8s">
                                <img src="assets/images/hero/hero-four_img-1.jpg" alt="hero image">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="features-section gray-bg pt-100 pb-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="features-content-box pl-lg-70 wow fadeInRight">
                            <p class="mb-25">Sit amet consectetue integer eu tincidunt scelerisque. Sodales
                                volutpat neque fermentum alesuada scelerisque massa.</p>
                            <div class="row justify-content-center">
                                <div class="col-sm-4 col-6">
                                    <!--=== Counter Item ===-->
                                    <div class="counter-item mb-55">
                                ...
                                <div class="col-sm-4 col-6">
                                    <!--=== Counter Item ===-->
                                    <div class="counter-item mb-55">
                                        <h2 class="number"><span class="count">852</span>+</h2>
                                        <p>Tent Sites</p>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-6">
                ...
                <div class="slider-active-5-item wow fadeInUp">
                    <!--=== Features Item ===-->
                    <div class="single-features-item-three">
                        <div class="img-holder">
                            <img src="assets/images/features/feat-10.jpg" alt="Features Image">
                        </div>
                        <div class="content">
                            <h6>Wadi Musa, Ma'an 
                                Governorate, Jordan</h6>
                        </div>
                    </div>
                    <!--=== Features Item ===-->
                    <div class="single-features-item-three">
                        <div class="img-holder">
                            <img src="assets/images/features/feat-11.jpg" alt="Features Image">
                        </div>
                        <div class="content">
                    ...
                    <div class="single-features-item-three">
                        <div class="img-holder">
                            <img src="assets/images/features/feat-12.jpg" alt="Features Image">
                        </div>
                        <div class="content">
                            <h6>Camper Trailer, 
                                New York</h6>
                    ...
                    <div class="single-features-item-three">
                        <div class="img-holder">
                            <img src="assets/images/features/feat-13.jpg" alt="Features Image">
                        </div>
                        <div class="content">
                            <h6>Wadi Musa, Ma'an 
                                Governorate, Jordan</h6>
                    ...
                    <div class="single-features-item-three">
                        <div class="img-holder">
                            <img src="assets/images/features/feat-14.jpg" alt="Features Image">
                        </div>
                        <div class="content">
                            <h6>Forest Tent Camping,
                                South Africa</h6>
                        </div>
                    </div>
                    <!--=== Features Item ===-->
                ...
                <div class="row align-items-xl-center">
                    <div class="col-xl-5 order-2 order-xl-1">
                        ...
                        <div class="we-image-box text-center text-xl-left pr-lg-30 mb-50 wow fadeInLeft">
                            <img src="assets/images/gallery/we-6.jpg" class="radius-top-left-right-288" alt="What We Image">
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="fancy-icon-box-three mb-30">
                                        ...
                                        <div class="text">
                                            <h5 class="title">Tent Camping</h5>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fancy-icon-box-three mb-30">
                                        ...
                                        <div class="text">
                                            <h5 class="title">Mountain Biking</h5>
                                            <a href="#" class="btn-link">Read More <i class="far fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="service-section-two black-bg pt-100 pb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <!--=== Section Title ===-->
                        <div class="section-title text-center text-white mb-45 wow fadeInDown">
                ...
                <div class="slider-active-3-item wow fadeInUp">
                    ...
                    <div class="single-service-item-four">
                        ...
                        <div class="content">
                            ...
                            <div class="action-btn">
                                <a href="tour-details.html" class="main-btn primary-btn">Read More<i class="far fa-paper-plane"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Service Item ===-->
                    <div class="single-service-item-four">
                        ...
                        <div class="content">
                            <a href="#" class="icon-btn"><i class="fas fa-heart"></i></a>
                            <h3 class="title">Glamping Cabin</h3>
                            <p>Sit amet consecteturauris natoque name
                                pellentue augue mattis faucibus</p>
                            <div class="meta">
                                <span class="icon"><i class="flaticon-blanket"></i></span>
                    ...
                    <div class="single-service-item-four">
                        ...
                        <div class="content">
                            <a href="#" class="icon-btn"><i class="fas fa-heart"></i></a>
                            <h3 class="title">RV Luxury Tent</h3>
                            <p>Sit amet consecteturauris natoque name
                                pellentue augue mattis faucibus</p>
                            <div class="meta">
                                <span class="icon"><i class="flaticon-blanket"></i></span>
                ...
                <!--=== Text Box ===-->
                <div class="big-text pt-100 wow fadeInDown">
                    <img src="assets/images/bg/adventure.png" alt="Adventure">
                </div>
            </div>
        </section><!--====== End Service Section ======-->
        <!--====== Start Places Section ======-->
        <section class="places-section pt-100 pb-70">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <!--=== Section Title ===-->
                        <div class="section-title text-center mb-50 wow fadeInDown">
                            <span class="sub-title">Popular Tour Place</span>
                            <h2>Visit & Enjoy Adventure Life
                                With Full Of Dreams</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-20.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Hiking Mountains</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Arefu, AG, Romania</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-21.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Surfer Riding Wave</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Arefu, AG, Romania</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-22.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Tracing Hill On Cloud</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Arefu, AG, Romania</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-23.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Hill House On Sea</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Gulf of Thailand, Thailand</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-24.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Tent Camping</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Wilderness, United States</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-25.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Hiking Mountains</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Arefu, AG, Romania</p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-26.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Climbing Up The Hills</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Arefu, AG, Romania</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-place-item-three mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-27.jpg" alt="Place Image">
                            </div>
                            <div class="place-content">
                                <h4 class="title"><a href="tour-details.html">Tracing Hill On Cloud</a></h4>
                                <p class="location"><i class="far fa-map-marker-alt"></i>Nordegg, Canada</p>
                                <div class="meta">
                                    <span><i class="far fa-calendar-alt"></i>25 Feb 2023</span>
                                    <a href="#" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                                </div>
                    ...
                    <div class="col-xl-7">
                        ...
                        <div class="choose-content-box pr-lg-70">
                            ...
                            <div class="section-title mb-45 wow fadeInDown">
                                ...
                                <h2>People Why Choose
                                    Our Travel Adventure</h2>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <!--=== Fancy Icon Box ===-->
        ...
        <section class="testimonial-section-two pt-100">
            <div class="container">
                <div class="row align-items-xl-center">
                    <div class="col-xl-5 order-2 order-xl-1">
                        <div class="testimonial-image-box text-xl-left text-center wow fadeInLeft">
                            <img src="assets/images/testimonial/testimonial-2.png" alt="Icon Image">
                        </div>
                    </div>
                    <div class="col-xl-7 order-1 order-xl-2">
                        <!--=== Testimonial Slider ===-->
                ...
                <div class="blog-area pt-60 pb-60">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <!--=== Single Blog Post ===-->
                            <div class="single-blog-post-three mb-40 wow fadeInUp">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <!--=== Single Blog Post ===-->
                            <div class="single-blog-post-three mb-40 wow fadeInDown">
                                <div class="post-thumbnail">
                ...
                <div class="partner-slider-one pt-80 pb-70 wow fadeInUp">
                    ...
                    <div class="single-partner-item">
                        <div class="partner-img">
                            <a href="#"><img src="assets/images/partner/partner-6.png" alt="Partner Image"></a>
                        </div>
                    </div>
                    <!--=== Partner Item ===-->
                    <div class="single-partner-item">
                ...
                <div class="footer-widget-area pt-75 pb-30">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6">
                            <!--=== Footer Widget ===-->
                            <div class="footer-widget service-nav-widget mb-40 pl-lg-70 wow fadeInRight">
