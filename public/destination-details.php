                ...
                <div class="destination-details-wrapper">
                    <div class="destination-info wow fadeInUp">
                        ...
                        <ul class="features-list mb-40">
                            ...
                            <li><span><i class="fas fa-badge-check"></i>Fishing</span></li>
                            <li><span><i class="fas fa-badge-check"></i>Mountain Biking</span></li>
                            <li><span><i class="fas fa-badge-check"></i>Free Wi-fi Internet</span></li>
                            <li><span><i class="fas fa-badge-check"></i>Transportation</span></li>
                            <li><span><i class="fas fa-badge-check"></i>Spa & GYM</span></li>
                        </ul>
                    </div>
                    ...
                    <div class="single-place-item mb-60">
                        ...
                        <div class="place-content">
                            <div class="info">
                                ...
                                <h4 class="title"><a href="tour-details.html">Man Standing on a Rock</a></h4>
                                <p class="location"><i class="fas fa-map-marker-alt"></i>North Province, Maldives</p>
                                <p class="price"><i class="fas fa-usd-circle"></i>Price<span class="currency">$</span>93.65</p>
                                <div class="meta">
                                    <span><i class="far fa-clock"></i>05 Days</span>
                ...
                <div class="footer-widget-area pt-75 pb-30">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <!--=== Footer Widget ===-->
                            <div class="footer-widget footer-newsletter-widget mb-40 pl-lg-100 wow fadeInDown">
